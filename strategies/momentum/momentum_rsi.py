...
class momentum_rsi(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['ma'] = ta.MA(dataframe['close'], timeperiod=200)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            ['enter_long', 'enter_tag']] = (0, 'long_white_soldiers')
        ...
        dataframe.loc[
            ...
            ['enter_short', 'enter_tag']] = (1, 'short_black_crows')
