...
class NostalgiaForInfinityX3121(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def exit_stoploss(self, mode_name: str, current_rate: float,
        ...
        if (
                ...
                # temporary
                and (trade.open_date_utc.replace(tzinfo=None) >= datetime(2023, 6, 6) or is_backtest)
        ):
                ...
                if (current_stake_amount < stake_amount_threshold):
                    if (
                            ...
                            (
                                ...
                                (
                                    (last_candle['rsi_14'] < 36.0)
                                    and (last_candle['close'] > last_candle['sar'])
