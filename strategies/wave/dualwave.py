...
class dualwave(IStrategy):
    ...
    from15 = IntParameter(low=15, high=35, default=25, space='buy', optimize=True)
    from2 = IntParameter(low=15, high=35, default=25, space='buy', optimize=True)
    ...
    fast_wave_buy = IntParameter(-50, 50, default=0, space='buy', optimize=True)
    slow_wave_buy = IntParameter(-50, 50, default=0, space='buy', optimize=True)
    ...
    fast_wave_sell = IntParameter(-50, 50, default=0, space='sell', optimize=True)
    slow_wave_sell = IntParameter(-50, 50, default=0, space='sell', optimize=True)

    ###  Buy Weight Mulitpliers ###
    x01 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x02 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x03 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x04 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x05 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x06 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x07 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x08 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x09 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)
    x10 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='buy', optimize=True)

    ###  Sell Weight Mulitpliers ###
    y01 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y02 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y03 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y04 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y05 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y06 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y07 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y08 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    y09 = DecimalParameter(0.3, 5.0, default=1, decimals=1, space='sell', optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.dp:
            ...
            informative['from_weight'] = -(informative['from_200'] * self.x03.value)
            ...
            informative['wave_weight'] = ((informative['wave_buy1']+informative['wave_buy2']+informative['wave_buy3'])/2) * self.x04.value
        ...
        dataframe['rsi_weight'] = (
            (dataframe['rsi_buy1']+dataframe['rsi_buy2']+dataframe['rsi_buy3']+dataframe['rsi_buy4'])/4) * self.x01.value
        ...
        dataframe['200SMA_weight'] = ((dataframe['sma_buy1']+dataframe['sma_buy2'])/2) * self.x04.value
        ...
        dataframe['willr_weight'] = ((dataframe['willr_buy1']+dataframe['willr_buy2']+dataframe['willr_buy3'])/3) * self.x05.value
        ...
        dataframe['rsi_weight_sell'] = (
            (dataframe['rsi_sell1']+dataframe['rsi_sell2']+dataframe['rsi_sell3']+dataframe['rsi_sell4'])/4) * self.y01.value
        ...
        dataframe['200SMA_weight_sell'] = ((dataframe['sma_sell1']+dataframe['sma_sell2'])/2) * self.y04.value
        ...
        dataframe['willr_weight_sell'] = ((dataframe['willr_sell1']+dataframe['willr_sell2']+dataframe['willr_sell3'])/3) * self.y05.value
