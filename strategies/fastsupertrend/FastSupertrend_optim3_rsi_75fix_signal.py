...
class FastSupertrend_optim3_rsi_75fix_signal(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            (
                (dataframe['supertrend_1_buy'].shift(1) == 'down') |
                (dataframe['supertrend_1_buy'].shift(2) == 'down') |
                (dataframe['supertrend_1_buy'].shift(3) == 'down') |
                (dataframe['supertrend_1_buy'].shift(4) == 'down') |
                (dataframe['supertrend_1_buy'].shift(5) == 'down') |
                (dataframe['supertrend_2_buy'].shift(1) == 'down') |
                (dataframe['supertrend_2_buy'].shift(2) == 'down') |
                (dataframe['supertrend_2_buy'].shift(3) == 'down') |
                (dataframe['supertrend_2_buy'].shift(4) == 'down') |
                (dataframe['supertrend_2_buy'].shift(5) == 'down') |
                (dataframe['supertrend_3_buy'].shift(1) == 'down') |
                (dataframe['supertrend_3_buy'].shift(2) == 'down') |
                (dataframe['supertrend_3_buy'].shift(3) == 'down') |
                (dataframe['supertrend_3_buy'].shift(4) == 'down') |
                (dataframe['supertrend_3_buy'].shift(5) == 'down')
            ) &
        ...
        dataframe.loc[
            ...
            (
                (dataframe['supertrend_1_sell'].shift(1) == 'up') |
                (dataframe['supertrend_1_sell'].shift(2) == 'up') |
                (dataframe['supertrend_1_sell'].shift(3) == 'up') |
                (dataframe['supertrend_1_sell'].shift(4) == 'up') |
                (dataframe['supertrend_1_sell'].shift(5) == 'up') |
                (dataframe['supertrend_2_sell'].shift(1) == 'up') |
                (dataframe['supertrend_2_sell'].shift(2) == 'up') |
                (dataframe['supertrend_2_sell'].shift(3) == 'up') |
                (dataframe['supertrend_2_sell'].shift(4) == 'up') |
                (dataframe['supertrend_2_sell'].shift(5) == 'up') |
                (dataframe['supertrend_3_sell'].shift(1) == 'up') |
                (dataframe['supertrend_3_sell'].shift(2) == 'up') |
                (dataframe['supertrend_3_sell'].shift(3) == 'up') |
                (dataframe['supertrend_3_sell'].shift(4) == 'up') |
                (dataframe['supertrend_3_sell'].shift(5) == 'up')
            ) &
