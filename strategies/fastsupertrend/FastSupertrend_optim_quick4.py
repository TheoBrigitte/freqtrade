...
class FastSupertrend_optim_quick4(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['slowrsi'] = ta.RSI(dataframe['close'], timeperiod=14)
        dataframe['slowrsi_ema'] = ta.EMA(dataframe['slowrsi'], timeperiod=14)
